...
\vspace{0.4em}
\textbf{Modal (recommended).}
You have access to the \codesm{teamvizuara} Modal profile --- token and instructions are on the course portal.
Use \codesm{A10G} (\codesm{gpu="A10G"}) with \codesm{--group 8 --bsz 2}.
A 1\,000-step run finishes in about 2 hours.
\end{qbox}
